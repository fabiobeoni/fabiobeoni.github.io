...
define('extensions/adapt-notes/js/adapt-notesView',['require','backbone','coreJS/adapt','./base64'],function(require) {
    ...
    var $Notes = function (Adapt,selector) {
        ...
        function _onExport() {
            ...
            href = href.replace('@content', JSON.stringify(_notes));
            ...
            if(searchValue){
                ...
                $(keys).each(function (i,key) {
                    var filtered = $.grep(_notes,function (note,i) {
                        return (note.title.indexOf(key)!==-1 || note.text.indexOf(key)!==-1);
                    });
...
define('extensions/adapt-notes/js/adapt-notes',[
    ...
    Adapt.once('app:dataReady', function() {
        ...
        //TODO: restore!       if (notesExtConfig._isEnabled === false) return;
